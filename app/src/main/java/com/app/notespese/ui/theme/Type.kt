...
// Tipografia Material3 con Roboto (font di sistema Android).
// In futuro si può sostituire con un font custom via Google Fonts Compose.
val NoteSpeseTipografia = Typography(
